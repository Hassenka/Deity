...
import 'package:diety/logic/product_bloc/favorites_bloc/favorites_bloc.dart';
...
class _FavoriteRecipesScreenState extends State<FavoriteRecipesScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => FavoritesBloc()..add(FetchFavorites()),
                      ...
                      builder: (context, state) {
                        if (state is FavoritesLoadInProgress) {
                          ...
                          if (state.recipes.isEmpty ||
                              state.recipes.first.recipes == null ||
                              state.recipes.first.recipes!.isEmpty) {
                            return Container(
                          ...
                          final allRecipes = state.recipes.first.recipes!;
